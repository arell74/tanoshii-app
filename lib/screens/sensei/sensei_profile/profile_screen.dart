      ...
      if (currentUser != null) {
        ...
        if (doc.exists && doc.data() != null) {
          ...
          return {
            ...
            'role': data['role'] ?? 'Sensei (Pengajar)"',
      ...
      body: SafeArea(
        child: FutureBuilder<Map<String, String>>(
          ...
          builder: (context, snapshot) {
            ...
            final String role = snapshot.data?['role'] ?? 'Sensei (Pengajar)';
            final String photoUrl = snapshot.data?['photoUrl'] ?? '';

            final bool isTeacher = role.toLowerCase() == 'Sensei (Pengajar)';
            final Color badgeColor = isTeacher ? indigo : gold;
            final String roleLabel = isTeacher ? 'Sensei 先生' : 'Sensei 先生';
