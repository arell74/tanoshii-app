                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            Container(
                              ...
                              decoration: BoxDecoration(
                                color: isDone
                                    ? sage.withOpacity(0.1)
                                    : vermillion.withOpacity(0.1),
                        ...
                        SizedBox(
                          ...
                          child: ElevatedButton(
                                ...
                                final dummyQuestions = [
                                  {
                                    ...
                                    'char': 'ね',
                                    'hint':
                                        'ね (ne) berasal dari kanji 根 yang berarti "akar". Ingat: bentuknya seperti huruf "ne"!',
                                    'options': [
                                      {
                                        'romaji': 'me',
                                        'kana': 'め',
                                ...
                                Navigator.push(
                                  ...
                                  MaterialPageRoute(
                                    builder: (context) => QuizScreen(
                                      ...
                                      module: quiz['module'],
                                      questions:
                                          dummyQuestions, // Lempar data soal
                                    ),
                                  ),
                                );
                              } else {
                            ...
                            child: Text(
                              isDone ? 'SUDAH DIKERJAKAN' : 'MULAI KUIS',
                              style: GoogleFonts.spaceMono(
                                fontSize: 12,
                                fontWeight: FontWeight.bold,
                              ),
